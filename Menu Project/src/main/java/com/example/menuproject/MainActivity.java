...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view){
        switch (view.getId()){
            case (R.id.button_1):
                Intent intent1 = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto:9174958129"));
                intent1.putExtra("sms_body", "Danni Huang");
                startActivity(intent1);
                break;
            case (R.id.button_2):
                Intent intent2 = new Intent(Intent.ACTION_DIAL);
                intent2.setData(Uri.parse("tel:9174958129"));
            ...
            case (R.id.button_3):
                ...
                break;
            case (R.id.button_4):
                Uri uri = Uri.parse("geo:22.797769,108.329981");
